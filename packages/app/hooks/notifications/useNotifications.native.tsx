...
export const useNotifications = () => {
  ...
  // const updateProfileMutation = api.me.profile.update.useMutation()
  useEffect(() => {
...
async function registerForPushNotificationsAsync() {
  ...
  if (Device.isDevice) {
    ...
    // Refer to eas.json for projectId
    token = (
      await Notifications.getExpoPushTokenAsync({ projectId: Constants.easConfig?.projectId })
    ).data
    console.log(token)
  } else {
